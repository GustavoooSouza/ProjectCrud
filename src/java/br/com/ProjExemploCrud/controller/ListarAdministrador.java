 ...
 * @author Usuário
 */
@WebServlet(name = "ListarAdministrador", urlPatterns = {"/ListarAdministrador"})
public class ListarAdministrador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("listaadm", dao.listar());
            request.getRequestDispatcher("adm/gerenciaradm.jsp").forward(request, response);
        }catch(Exception ex){
            System.out.println("Erro no Servlet ListarAdministrador");
            ex.printStackTrace();
        }
    }
