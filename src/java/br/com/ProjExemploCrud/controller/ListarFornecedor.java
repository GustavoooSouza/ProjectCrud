...
public class ListarFornecedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("listafornecedor", dao.listar());
            request.getRequestDispatcher("fornecedor/gerenciarfornecedor.jsp").forward(request, response);
        }catch(Exception ex){
            System.out.println("Erro no Servlet ListarFornecedor");
            ex.printStackTrace();
        }
    }
